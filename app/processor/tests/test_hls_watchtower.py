...
class TestHLSWatchtower:
    ...
    def test_read_playlist_file_not_exists(self):
        ...
        with patch("os.path.exists", return_value=False), patch("time.sleep") as mock_sleep:
    ...
    def test_read_playlist_retry_delay_caps_at_max(self):
        ...
        with patch("os.path.exists", return_value=False), patch("time.sleep"):
    ...
    def test_read_playlist_with_segments(self):
        ...
        with patch("os.path.exists", return_value=True), patch("builtins.open", mock_open(read_data=playlist_content)):
            result = watchtower.read_playlist("/fake/path/playlist.m3u8")
